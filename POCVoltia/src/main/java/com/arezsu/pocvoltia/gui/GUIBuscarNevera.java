 ...
 * @author arezs
 */
public class GUIBuscarNevera extends javax.swing.JFrame {

    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(GUIBuscarNevera.class.getName());

    /**
     * Creates new form GUIBuscarLavadora
     */
    public GUIBuscarNevera() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new GUIBuscarNevera().setVisible(true));
    }
